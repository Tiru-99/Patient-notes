    ...
    return (
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          <div className="">
            <p className="inline-block px-3 py-px mb-4 bg-teal-300 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
              Dream Team
            </p>
          </div>
          ...
          United by Passion, Driven by Innovation—A Diverse Team of Visionaries Committed to Turning Ideas into Impactful Realities.
          </p>
        </div>
        <div className="grid gap-10 row-gap-8 mx-auto sm:row-gap-10 lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-3 sm:ml-36">
          <div className="flex">
            <img
