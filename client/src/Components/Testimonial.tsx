        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="flex flex-col items-center">
                <div className="text-center">
                    <p className="text-lg font-medium text-gray-600 font-pj">2,157 people have said how good Patientnotes</p>
                            ...
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">"Patient Notes has transformed the way I document patient interactions. The AI-powered note-taking is incredibly accurate, saving me hours each week!"
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-0.5 text-sm font-pj text-gray-600">Orthopaedic</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-0.5 text-sm font-pj text-gray-600">General Physician</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col overflow-hidden shadow-xl">
                            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                <div className="flex-1">
                                    ...
                                    <blockquote className="flex-1 mt-8">
                                        <p className="text-lg leading-relaxed text-gray-900 font-pj">“As a busy doctor, I rely on Patient Notes to capture detailed, organized notes effortlessly. It’s like having a personal assistant by my side!”</p>
                                    </blockquote>
                                </div>
                                ...
                                <div className="flex items-center mt-8">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="mt-0.5 text-sm font-pj text-gray-600">Pediatrist</p>
                                    </div>
                                </div>
                            </div>
                        </div>
